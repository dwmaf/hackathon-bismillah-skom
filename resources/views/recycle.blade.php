...
<div class="d-flex justify-content-center mb-5 mt-5" style="height: 120vh;">
    <form action="/submitrecycle" class="bg-white container shadow p-5 rounded" style="max-width: 900px;" enctype="multipart/form-data" method="POST">
        @csrf
        <h4 class="text-center mb-4 text-success">Formulir Pengajuan Barang untuk Daur Ulang</h4>
        <p class="text-muted text-center mb-4">Isi detail barang yang ingin Anda daur ulang. Pastikan informasi lengkap dan akurat.</p>
        ...
        <div class="d-flex flex-column gap-4">
            ...
            <div>
                ...
                <input type="text" class="form-control border border-success" id="inputModel" name="model" placeholder="Contoh: iPhone 11, Samsung Galaxy S20" required>
            </div>
            
            <!-- Kondisi Input -->
            <div>
                <label for="inputKondisi" class="form-label fw-bold">Kondisi Barang</label>
                <input type="text" class="form-control border border-success" id="inputKondisi" name="kondisi" placeholder="Contoh: Masih berfungsi, layar retak, atau rusak total" required>
            </div>
            
            <!-- File Upload -->
            <div>
                <label for="formFile" class="form-label fw-bold">Foto Barang</label>
                <input class="form-control border border-success" type="file" id="formFile" name="foto" accept="image/*" required>
            ...
            <div>
                ...
                <textarea class="form-control border border-success" id="inputDeskripsi" rows="3" name="deskripsi" placeholder="Contoh: Warna perangkat, kerusakan khusus, atau aksesoris tambahan" required></textarea>
            </div>
